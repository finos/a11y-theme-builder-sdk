...
const expectedCssVars = [
    ...
    "--overline-largeCharacterSpacing",
    "--overline-XLFontSize",
    ...
    "--small-semiboldCharacterSpacing",
    "--label-1FontSize",
    "--label-1FontFamily",
    "--label-1FontWeight",
    "--label-1LineHeight",
    ...
    "--label-1-allCapsCharacterSpacing",
    "--label-2FontSize",
    "--label-2FontFamily",
    "--label-2FontWeight",
    "--label-2LineHeight",
    ...
    "--label-2-allCapsCharacterSpacing",
    "--label-smallFontSize",
